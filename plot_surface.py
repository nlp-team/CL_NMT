...
def crunch(surf_file, net, w, s, d, dataloader, loss_key, acc_key, comm, rank, args):
    ...
    for count, ind in enumerate(inds):
        ...
        loss, acc = evaluation.eval_loss(net, criterion, dataloader, args)
...
if __name__ == '__main__':
    ...
    if args.dataset=='cifar10':
        ...
        trainset = torchvision.datasets.MNIST(root='minist/data', train=True, download=True,
                                            transform=transforms.Compose([
                                                transforms.ToTensor(),
                                                transforms.Normalize((0.1307,), (0.3081,))
                                            ]))
        testset = torchvision.datasets.MNIST(root='minist/data', train=False, download=True,
                                             transform=transforms.Compose([
                                                 transforms.ToTensor(),
                                                 transforms.Normalize((0.1307,), (0.3081, ))
                                             ]))
